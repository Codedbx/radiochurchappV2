...
import { Play, Pause, Volume2, VolumeX, Heart, Radio, Loader2, Phone } from "lucide-react";
          ...
          <Card className="bg-white gap-0 backdrop-blur-sm border-0 shadow-xl dark:bg-slate-800/70">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center justify-center gap-6">
                ...
                >
                  {audioProps.isMuted ? <VolumeX className="h-5 w-5" /> : <Volume2 className="h-5 w-5" />}
                </Button>
              </div>
              {audioProps.error && (
                <div className="text-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                  <p className="text-red-600 dark:text-red-400 text-sm">{audioProps.error}</p>
                </div>
              )}
